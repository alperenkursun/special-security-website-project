...
import silahli_egitim from "../../images/silahli_egitim.jpg";

function ArmedEducation() {
  return (
    <Box className={styles.mainpageContainer}>
      <h1 className={styles.header}>SİLAHLI EĞİTİM</h1>
      {/* prettier-ignore */}
      ...
      <ol>
        ...
        <li className={styles.paragraph}>{"    "}21 yaşını doldurmuş olmak</li>
        <li className={styles.paragraph}>
      ...
      <img src={silahli_egitim} alt="Silahlı Eğitim" />
    </Box>
  );
}

export default ArmedEducation;
